#property copyright "Copyright 2013, MetaQuotes Ltd."
...
input int InpMagic    = 123457; // EA Identification no
...
input StartHour SHInput; // Start Hour
...
input EndHour EHInput; // End Hour
...
void OnTick()
{
    ...
    {
        pos.SelectByIndex(i);
        if (pos.PositionType() == POSITION_TYPE_BUY && pos.Symbol() == Symbol() && pos.Magic() == InpMagic) BuyTotal++;
        if (pos.PositionType() == POSITION_TYPE_SELL && pos.Symbol() == Symbol() && pos.Magic() == InpMagic) SellTotal++;
    }
